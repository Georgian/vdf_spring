...
import com.ggrec.vdf_spring.security.TokenHandler;
...
public class TokenAuthenticationService {
    ...
    public void addAuthentication(HttpServletResponse response, VDFAccountAuthentication authentication) {
        final VDFAccount user = authentication.getDetails();
    ...
    public VDFAccountAuthentication getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            final VDFAccount user = tokenHandler.parseUserFromToken(token);
            if (user != null) {
                return new VDFAccountAuthentication(user);
            }
        }
        return null;
    }
